...
INSTALL_PREFIX="/g/g90/lumsden1/ws/insitu_benchmark/Src_Benchmark_InSitu/_corona_install"
## Output directory for the benchmark
OUT_DIR="/g/g90/lumsden1/ws/insitu_benchmark/Src_Benchmark_InSitu/submit/point2point/dyad_test_corona/out"
