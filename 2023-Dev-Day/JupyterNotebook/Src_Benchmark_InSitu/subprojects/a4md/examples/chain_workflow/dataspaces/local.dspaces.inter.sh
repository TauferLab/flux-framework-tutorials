...
## Interval
INTERVAL=2
## Number of consumer steps
CON_NSTEPS=$(( $NSTEPS/$INTERVAL ))
...
do
	...
	do
	    ...
	    intermediator_cmd="mpirun -np $NP_INTERMEDIATOR ./chain_intermediator $client_id $group_id $client_id $sub_group_id ./forward.py direct $NSTEPS $INTERVAL"
	    ...
	    do
	        ...
	        consumer_cmd="mpirun -np $NP_READER ./chain_consumer $client_id $sub_group_id ./compute.py analyze $CON_NSTEPS"
	        echo ${consumer_cmd}
