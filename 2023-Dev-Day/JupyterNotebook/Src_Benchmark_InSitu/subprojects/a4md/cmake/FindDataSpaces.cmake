...
if(NOT DATASPACES_ROOT)
	if(NOT ("$ENV{DATASPACES_ROOT}" STREQUAL ""))
		...
		find_program(DSPACES_CONF dspaces_config HINTS
			${DATASPACES_PREFIX}/bin
			/usr/bin
			/usr/local/bin
			/opt/local/bin
			/sw/bin
...
find_package_handle_standard_args(DataSpaces
	...
	REQUIRED_VARS DATASPACES_VERSION DATASPACES_INCLUDE_DIR DATASPACES_LIBRARIES DATASPACES_LIBRARY
)

MARK_AS_ADVANCED(
	DATASPACES_VERSION
	DATASPACES_ROOT
	DATASPACES_INCLUDE_DIR
	DATASPACES_LIBRARIES
	DATASPACES_LIBRARY
	DATASPACES_FOUND
)
